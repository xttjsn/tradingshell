      ...
      y: [
        {
          ...
          value: currentItem.portfolioValue && numberFormat(currentItem.portfolioValue)
        }
      ]
        .concat(
          ys.map(each => ({
...
const keyValues = ["portfolioValue"];
    ...
    return (
      ...
      >
        ...
        >
          ...
          <LineSeries yAccessor={d => d.portfolioValue}/>
